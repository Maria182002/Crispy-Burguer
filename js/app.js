...
function cargarEventListeners(){
    platillos.addEventListeners('click', comprarPlatillo);
    carrito.addEventListeners('click', eliminarPlatillo);
    vaciarCarritoBtn.addEventListeners('click', vaciarCarrito);
    document.addEventListeners('DOMContentLoaded', leerLocalStorage);
}
